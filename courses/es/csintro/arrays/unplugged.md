...
* What did she do?   Try to get students to be as precise as possible in explaining their thinking. Sometimes it helps to put the steps on the board, in an algorithm:
* *First, she went to the first student, then put him in the right place.*
* *Then she went to each of the next students and put them in the right place.*   Ask for clarification when necessary: *What does it mean when you say “put them in the right place”?*   *To Put Someone in the Right Place:*
...
5. Repeat steps 2 through 4 as long as counter is greater than zero.   ![Bubble Sort Animation](/static/courses/csintro/arrays/bubble-sort.gif)
